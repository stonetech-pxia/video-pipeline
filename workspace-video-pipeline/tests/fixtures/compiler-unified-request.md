...
Frame Design:
{
  ...
  "frame_plan": [{
    ...
    "generate_last_frame_target": false,
    "capture_actual_tail_frame": false
  }],
  "image_jobs": [],
  "media_manifest": {
    "status": "ready_for_compile",
    "supports_mixed_keyframes_and_references": true,
    "media": [
      {
        "id": "FF001",
        "type": "frame",
        ...
        "entity_bindings": {"character_ids": ["C01"], "location_ids": []},
